...
object MessageFixtures {
    ...
    val ALL: List<ControlMessage> = listOf(
        ...
        RemoteStart(maxWidth = 1600, maxHeight = 2560, fps = 60, input = true),
        RemoteAccept(codec = "h264", width = 1600, height = 1000, fps = 60, input = true),
        RemoteReject(reason = "screenPermission"),
        RemoteStop,
        RemoteInput(events = listOf(RemoteInputEvent(kind = "pa", x = 0.5, y = 0.5))),
        Ping(12),
        Pong(12),
        CLIP,
