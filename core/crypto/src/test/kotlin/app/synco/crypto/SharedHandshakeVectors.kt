...
internal data class SharedHandshakeVector(
    val name: String,
    val staticPrivateA: String,
    val staticPrivateB: String,
    val ephemeralPrivateA: String,
    val ephemeralPrivateB: String,
    val staticPublicA: String,
    val staticPublicB: String,
    val ephemeralPublicA: String,
    val ephemeralPublicB: String,
    val deviceIdA: String,
    val deviceIdB: String,
    val initiatorToResponderKey: String,
    val responderToInitiatorKey: String,
    val initiatorTag: String,
    val responderTag: String,
)

internal val SHARED_HANDSHAKE_VECTORS = listOf(
